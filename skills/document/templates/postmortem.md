...
<The proven cause, with the evidence. Where /debug investigated this, its record already holds a cause confirmed by evidence rather than assumed, so use that.>
