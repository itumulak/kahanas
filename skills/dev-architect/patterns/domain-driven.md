...
**Panel label**: Domain Driven Design (DDD)
**Panel description**: Model the business domain explicitly. Bounded contexts, aggregates, and domain events. Best for complex, evolving business logic.
...
Read this file only when the user picks this style. Its Conventions list is written verbatim into `code-standards.md` under Language and Framework Conventions, adapted to the actual stack. Do not paraphrase it into something vaguer.
